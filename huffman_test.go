...
func createStringOfRandomASCIIChars(size int) string {

	res := ""
	for i := 0; i < size; i++ {
		ranByte := byte(rand.Intn(256))
		for ranByte == 0 || ranByte == '_' {
			ranByte = byte(rand.Intn(256))
		}
		res += string(ranByte)
	}
...
func TestAll(t *testing.T) {
	...
	testDataToCompress := []string{testStr1, testStr2, createStringOfRandomASCIIChars(5000), createStringOfRandomASCIIChars(100000)}
